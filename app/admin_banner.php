...
<div class="container">
	<div class="row">
		<div class="col-md-6">
			...
			<br>		
			<div style="background-color:#e6e6f6; padding:1em;">
				<form action="<?php echo GUARDAR_BANNER; ?>" method="POST" enctype="multipart/form-data">
					<center>
						<!-- Nombra no mas de 50 caracteres -->
						<input style="color:black; background-color:#c5c6c6;" type="text" name="nombre" placeholder="Nombre de la imagen..." value="" required autofocus>	
						<br><br>
